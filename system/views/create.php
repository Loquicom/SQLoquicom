...
<div class="container">
    <div class="row-fluid">
        <div class="col8">
            <a href="<?= $_config['web_root'] ?>Affichage" class="btn btn-default main-color text-color inline" title="Retour" style="margin-right: 1em;"><i class="material-icons">arrow_back</i></a>
...
$(document).ready(function(){
    ...
    $('.valid_insert').on('click', function(){
        ...
        $.post('<?= $_config['web_root'] ?>Create/ajx_create', params, function(data){
